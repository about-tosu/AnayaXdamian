...
You can donate by contacting my owner: [Tosu](http://t.me/its_damiann)
     """
...
Join my [News Channel](https://t.me/about_tosuu) to get information on all the latest updates."""
...
Join my [News Channel](http://t.me/about_tosuu) to get information on all the latest updates."""
...
async def commands_menu(_, q: CallbackQuery):
    ...
    try:
        cpt = f"""
Hey **[{q.from_user.first_name}](http://t.me/{q.from_user.username})**! I am ᴀɴʏᴀ x ᴅᴀᴍᴀɪɴ✨.
I'm here to help you manage your group(s)!
Commands available:
× /start: Start the bot
